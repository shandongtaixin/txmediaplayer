...
#ifdef FFP_MERGE /*- FFPMERGE BEGIN -----------------*/
#include "config.h"
#include <inttypes.h>
#include <math.h>
#include <limits.h>
...
static int queue_picture(FFPlayer *ffp, AVFrame *src_frame, double pts, int64_t pos, double duration, int serial)
{
    VideoState *is = ffp->is;
    VideoPicture *vp;
    int drop_frame = 0;
